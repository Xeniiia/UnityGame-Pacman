...
public class AllData
{
    ...
    [ProtoMember(2)]
    PacmanStartPosProtobufClass StartPosClass;
    [ProtoMember(3)]
    LevelProtobufClass LevelClass;
...
public class LevelProtobufClass
{
    ...
    [ProtoMember(3)]
    public List<DemoPacman.Point> wall { get; set; }

    public LevelProtobufClass(int sizeX, int sizeY, List<DemoPacman.Point> list)
    {
        sizeX_proto = sizeX;
        sizeY_proto = sizeY;
        wall = list;
